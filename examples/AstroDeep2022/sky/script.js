  ...
  for (i = 0; i < 300; i++) {
    $(".stars").append(
      star1
        ...
        .replace("{{duration}}", getRandomInt(6, 8))
    );
  ...
  for (i = 0; i < 150; i++) {
    $(".stars").append(
      star0
        ...
        .replace("{{left}}", getRandomInt(0, 100))
        .replace("{{duration}}", getRandomInt(3, 5.5))
    );
    ...
    $(".stars").append(
      star1
        .replace("{{top}}", getRandomInt(0, 50))
        .replace("{{left}}", getRandomInt(0, 100))
        .replace("{{duration}}", getRandomInt(5.5, 6))
    );
  ...
  for (i = 0; i < 100; i++) {
    $(".stars").append(
      star0
        ...
        .replace("{{left}}", getRandomInt(0, 100))
        .replace("{{duration}}", getRandomInt(10, 30))
    );
    ...
    $(".stars").append(
      star1
        .replace("{{top}}", getRandomInt(40, 75))
        .replace("{{left}}", getRandomInt(0, 100))
        .replace("{{duration}}", getRandomInt(20, 40))
    );
  }
